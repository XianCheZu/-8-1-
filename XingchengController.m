...
- (void)createLeft{
    ...
    _leftTableView = [[UITableView alloc] initWithFrame:CGRectMake(0, ScreenWidth*0.14, ScreenWidth, self.view.frame.size.height - ScreenWidth*0.14-49)];
...
- (void)createRight{
    ...
    _rightTableView = [[UITableView alloc] initWithFrame:CGRectMake(0, ScreenWidth*0.14, ScreenWidth, self.view.frame.size.height - ScreenWidth*0.14-49)];

...
{
    NSString *qianqian=[NSString stringWithFormat:@"%@",[[NSUserDefaults standardUserDefaults] valueForKey:@"qianqianqian"]];
    NSLog(@"qian==%@",qianqian);
    
    //订单标题，展示给用户
    NSString *order_name    = @"闲车支付";
    //订单金额,单位（分）
    NSString *order_price   =[NSString stringWithFormat:@"%.0f",[qianqian floatValue]*100];//1分钱测试
    [NSString stringWithFormat:@"%.0f",[qianqian floatValue]*100];
//    NSString *order_price   =@"1";
    ...
    NSString *orderno   = [NSString stringWithFormat:@"%@",[self generate]];
...
- (NSString *)generate
{
    ...
    NSString *timeeeee=[locationString stringByAppendingString:resultStr];

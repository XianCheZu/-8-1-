...
-(UIToolbar *)setToolbarStyle{
    ...
    dict[NSForegroundColorAttributeName] = Color(0, 215, 200);
    [lefttem setTitleTextAttributes:dict forState:UIControlStateNormal];
...
-(void)pickerView:(UIPickerView *)pickerView didSelectRow:(NSInteger)row inComponent:(NSInteger)component{
    NSLog(@"你点击了PICKVIEW的第%ld个",row);
    
    [[NSNotificationCenter defaultCenter] postNotificationName:@"PICKVIEW.ROW" object:[NSString stringWithFormat:@"%ld",(long)row]];

...
- (void)_initScrollView
{
    ...
    if (!self.withoutPageControl) {
        _pageControl = ({
            UIPageControl *pageControl = [[UIPageControl alloc] initWithFrame:CGRectMake((_scrollView.frame.size.width-100)/2,_scrollView.frame.size.height-ScreenWidth*0.156 , 100, 15)];
            
            UIColor *color=Color(18, 152, 233)
            [pageControl setCurrentPageIndicatorTintColor:color];
    ...
    for (NSInteger i = 0; i < _slideImagesArray.count; i++) {
        ...
        [slideImage setImage:[UIImage imageNamed:_slideImagesArray[i]]];
        slideImage.contentMode = UIViewContentModeScaleAspectFit;
        slideImage.tag = i;
        slideImage.frame = CGRectMake(_scrollView.frame.size.width * i + _scrollView.frame.size.width+( _scrollView.frame.size.width- _scrollView.frame.size.width/1.5)/2, 0, _scrollView.frame.size.width/1.5, _scrollView.frame.size.height);
    ...
    firstSlideImage.contentMode = UIViewContentModeScaleAspectFit;
    firstSlideImage.frame = CGRectMake(0, 0, _scrollView.frame.size.width/1.3, _scrollView.frame.size.height);
    ...
    [firstSlideImage setImage:[UIImage imageNamed:_slideImagesArray[0]]];

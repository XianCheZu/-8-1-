...
- (instancetype)init
{
    if (self = [super init]) {
        ...
        _pickerView.frame = CGRectMake(0,0, kWinW, kPVH);
...
- (void)confirmBtnClick:(id)sender
{
    ...
    BOOL diss_yes_no=[[NSUserDefaults standardUserDefaults] boolForKey:@"BOOL_YES"];
    if (diss_yes_no) {
...
- (void)pushDatePicker
{
    ...
    [UIView animateWithDuration:0.2 animations:^{
        weakSelf.pickerView.frame = CGRectMake(0,0, kWinW, kPVH);

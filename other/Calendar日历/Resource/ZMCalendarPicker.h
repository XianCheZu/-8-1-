 ...
 *                        chooseDateArray中第一组数组返回为10，第二组为11，依次+1
 */
- (void)calendarPicker:(ZMCalendarPicker *)calendarPicker DidChooseDate:(NSDate *)chooseDate withStatus:(NSInteger)status week:(NSInteger)week;

@end

@interface ZMCalendarPicker : UIView
{
    NSMutableArray * integer_number;
}

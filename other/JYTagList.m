...
//文字颜色
#define TEXT_COLOR [UIColor colorWithRed:0 green:0.66 blue:0.933 alpha:1.00]
//文字阴影
#define TEXT_SHADOW_COLOR [UIColor whiteColor]
//文字偏移
#define TEXT_SHADOW_OFFSET CGSizeMake(0.0f, 1.0f)
//框.边颜色
#define BORDER_COLOR [UIColor colorWithRed:0 green:0.66 blue:0.933 alpha:1.00].CGColor
//框.边宽
#define BORDER_WIDTH ScreenWidth*0.0025

@implementation JYTagList
...
- (void)display
{
    ...
    for (NSString *text in textArray) {
        ...
        if (!gotPreviousFrame) {
            ...
            [[NSNotificationCenter defaultCenter] postNotificationName:@"manzu1" object:num];

...
-(void)creatTimer {
    ...
    _chezhutimer =[NSTimer scheduledTimerWithTimeInterval:10 target:self selector:@selector(timer11:) userInfo:nil repeats:YES];
}

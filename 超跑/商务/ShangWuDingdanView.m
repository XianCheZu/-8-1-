...
- (void)createFollowView{
    ...
    scrollView.contentSize = CGSizeMake(0, width*4.07);
    ...
    dPrice.text = [NSString stringWithFormat:@"¥ %d",[self.price intValue]/10/3*10];
    ...
    wPrice.text = [NSString stringWithFormat:@"¥ %d",[self.price intValue] - [self.price intValue]/10/3*10];
